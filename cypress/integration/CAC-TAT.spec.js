...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function(){
        ...
        cy.get('#lastName').type('Bernardo')
        cy.get('#email').type('allan@email.com')
    ...
    it('exibe mensagem de erro ao submeter formulário com email com formatação inválida', function(){
        cy.get('#firstName').type('Allan')
        cy.get('#lastName').type('Bernardo')
        cy.get('#email').type('Email Errado')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        ...
        cy.get('#lastName')
          .type('Bernardo')
          .should('have.value', 'Bernardo')
          .clear()
          .should('have.value', '')
        cy.get('#email')
          .type('allan@email.com')
          .should('have.value', 'allan@email.com')
          .clear()
          .should('have.value', '')
        cy.get('#phone')
          .type('1234567890')
    ...
    it('selecionaum produto (YouTube) por seu texto', function(){
        cy.get('#product')
          .select('YouTube')
    ...
    it('verifica que a política de privacidade abre em um outra aba sem necessidade de um clique', function() {
      cy.get('#privacy a').should('have.attr', 'target', '_blank')
    })

    it('acessa a página de privacidade removendo o target do link', function() {
      cy.get('#privacy a')
